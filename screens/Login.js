  ...
  return (
    ...
    <StyledContainer>
      ...
      <InnerContainer>
        ...
        <PageTitle>Smart and Effective IoT and GNSS Technology based Tea farming and Tourism for Tea Community Development</PageTitle>
        <ExtraSubTitle>A CSR activity of Higher Education Financial Agency (HEFA)</ExtraSubTitle>
        <SubTitle style={{ color: '#4682B4' }}>Implemented by NIT Jamshedpur </SubTitle>
